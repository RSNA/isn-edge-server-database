...
CREATE DATABASE rsnadb WITH TEMPLATE = template1 ENCODING = 'UTF8' LC_COLLATE = 'en_US.UTF-8' LC_CTYPE = 'en_US.UTF-8';
...
--
-- Name: hipaa_audit_accession_numbers_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('hipaa_audit_accession_numbers_id_seq', 1, false);
...
--
-- Name: hipaa_audit_mrns_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('hipaa_audit_mrns_id_seq', 1, false);
...
--
-- Name: hipaa_audit_views_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('hipaa_audit_views_id_seq', 1, false);
...
COMMENT ON TABLE transactions IS 'status logging/auditing for jobs defined in table Jobs. The java apps come here to determine their work';
...
1	DCM4CHEE	nibib-3.wustl.edu	11112	2010-09-08 13:41:25.663885-05
\.
...
--
-- Data for Name: hipaa_audit_accession_numbers; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: hipaa_audit_mrns; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: hipaa_audit_views; Type: TABLE DATA; Schema: public; Owner: postgres
--
